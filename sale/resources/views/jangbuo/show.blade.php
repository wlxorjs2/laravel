...
<br>
		...
		<table class="table table-bordered table-sm mymargin5">
			...
			<tr>
				...
				<td align="left">{{ number_format($row->numo32)}}</td>
			</tr>
			<tr>
		...
		<div align="center">
			<a href = "{{route('jangbuo.edit', $row->id)}}{{$tmp}}"  class="btn mycolor1 btn-sm hmycolor1">수정</a>
			<form action="{{ route('jangbuo.destroy', $row->id) }}{{$tmp}}">
				@csrf
				@method('DELETE')
