...
<br>
		...
		<table class="table table-bordered table-sm mymargin5">
			...
			<tr>
				...
				<td width = "80%" align="left">					
					<div class="d-inline-flex">
						...
						<input type="text" name = "product_name32" value = "{{ $row->product_name32 }}" class = "form-control form-control-sm" readonly> &nbsp;
			...
			<tr>
				...
				<td width = "80%" align="left">					
					<div class="form-inline">
						<input type="text" name="numo32" size="20" value = "{{$row->numo32}}" 
								   class="form-control form-control-sm" onchange="cal_prices();">
					</div>
				</td>
			</tr>
