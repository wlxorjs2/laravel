		...
		<form name="form1" action="" >
			<div class="row">
				...
				<div class="col-9" align="right">           
					...
					<a href="#ajaxModal" class="ajax_add btn btn-sm mycolor1"
					data-bs-toggle="modal" data-bs-target="#ajaxModal">추가</a>
				</div>
			</div>
		</form>
		...
		<table class="table table-bordered  table-sm  table-hover mymargin5" id = "table_list">
			...
			<tr id = "rowno{{ $row->id }}">
				...
				<td>
					...
					data-id="{{ $row->id }}" data-name="{{ $row->name32 }}">{{ $row->name32 }}</a>
				</td>
			...
			<form name = "form2" method = "post" action="">
				...
				<table class = "table table-sm table-borderless mymargin5">
					...
					<tr>
						<td>구분명</td>
						<td>
							<input type="text" name = "name32" id = "data_name" class = "form-control form-control-sm">
						</td>
					</tr>
				</table>
			</form>
