    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				@if(!session()->exists('uid32'))
					<a href="#" class="btn btn-sm btn-outline-info btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal">로그인</a>
				@else
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carosel"
           ...
           <div class="modal-body bg-light">
              ...
              <table class="table table-borderless mymargin5">
                  <tr>
                      ...
                      <td width="70%"><input type="text" name="uid32" class="form-control"></td>
                  </tr>
                  <tr>
                      <td><h6>암&nbsp;호</h6></td>
                      <td><input type="password" name="pwd32" class="form-control"></td>
                  </tr>
              </table>
              </form>
          </div>
